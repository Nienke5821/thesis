...
timings = [[current_time_hour, current_time_minute + 1], [current_time_hour, current_time_minute],
           [current_time_hour, current_time_minute + 2], [current_time_hour, current_time_minute + 3]]
...
def show_lizz():
    ...
    while True:
        ...
        pygame.display.update(pygame.Rect(0, 0, 500, 280))
...
while running:
    ...
    updated = check_notifications.check_can_be_given(
        can_be_given, give_now)  # Check notification that can be given
    ...
    if give_user:  # Show the notifications
